...
$('.js-addwish-b2').each(function(){
	...
	$(this).on('click', function(){
		swal(nameProduct, "¡Se agrego al contrato!", "success");
	...
	$(this).on('click', function(){
	    ...
	    request.onreadystatechange = function(){
	        ...
	        if(request.status == 200){
	        	...
	        	if(objData.status){
		            document.querySelector("#serviciosCarrito").innerHTML = objData.htmlCarrito;
	    ...
	    request.onreadystatechange = function(){
	    	...
	    	if(request.status == 200){
	    		...
	    		if(objData.status){
	    			...
	    			colSubtotal.cells[4].textContent = objData.totalServicio;
	    			document.querySelector("#subTotalCompra").innerHTML = objData.subTotal;
	    			document.querySelector("#totalCompra").innerHTML = objData.total;
	    		}else{
	    			swal("", objData.msg , "error");
...
if(document.querySelector("#btnComprar")){
	...
	btnPago.addEventListener('click',function() { 
	    ...
	    if( txtDireccion == "" || txtCiudad == "" || txtMateriales == "" || txtDetalles == "" || inttipopago == ""){
			swal("", "Complete datos del contrato" , "error");
			return;
		}else{
			divLoading.style.display = "flex";
