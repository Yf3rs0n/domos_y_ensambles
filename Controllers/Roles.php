<?php 
	...
	class Roles extends Controllers{
		...
		public function Roles()
		{
			...
			$data['page_title'] = "Roles Usuario <small> Domos y Ensambles</small>";
		...
		public function getRoles()
		{
			if($_SESSION['permisosMod']['r']){
				...
				//FORMATO JSON PARA QUE PUEDA SER INTERPRETADO POR CUALQUIER LENGUAJE DE PROGRAMACION
		...
		public function setRol(){
				...
				if($intIdrol == 0)
				{
					...
					if($_SESSION['permisosMod']['w']){
						$request_rol = $this->model->insertRol($strRol, $strDescipcion,$intStatus);//VALIDAMOS LA RESPUESTA DEL METODO DE CREAR UN ROL
						$option = 1;
					}
				}else{
					//Actualizar
				...
				if($request_rol > 0 )//EVALUAMOS LA RESPUESTA DEL METODO Y MOSTRAMOS UN MENSAJE
				{
					if($option == 1)
					{
				...
				echo json_encode($arrResponse,JSON_UNESCAPED_UNICODE);//EL ARRAY SERA ENVIADO EN FORMATO JSON 
			die();
		}
