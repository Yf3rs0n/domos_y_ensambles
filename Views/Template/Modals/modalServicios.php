  ...
  <div class="modal-dialog modal-xl" >
    <div class="modal-content">
      <div class="modal-header headerRegister">
        <h5 class="modal-title" id="titleModal">Nueva Servicio</h5>
              ...
              <div class="row">
                <div class="col-md-8">
                    <div class="form-group">
                      <label class="control-label">Nombre Servicio <span class="required">*</span></label>
              ...
              <div class="tile-footer">
                 <div class="form-group col-md-12">
                     ...
                     <div id="containerImages">
                         <!-- <div id="div24">
                             <div class="prevImage">
                                 <img src="<?= media(); ?>/images/uploads/servicio1.jpg">
                             </div>
