...
<head>
	...
	//Datos de
		...
		if(!empty($data['servicio'])){
			...
			$urlWeb = base_url()."/tienda/servicio/".$data['servicio']['idservicio']."/".$data['servicio']['ruta'];
			$urlImg = $data['servicio']['images'][0]['url_image'];
		}
	?>
	...
	<meta property="og:title"       content="<?= $nombreServicio; ?>" />
...
<body class="animsition">
	...
	<header>
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<div class="wrap-icon-header flex-w flex-r-m">
						...
						<div class="cantCarrito icon-header-item cl5 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti js-show-cart" data-notify="<?= $cantCarrito; ?> ">
		...
		<div class="menu-mobile">
			...
			<ul class="main-menu-m">
				...
				<li>
					<a href="<?= base_url(); ?>/carrito">Contrato</a>
				</li>
	...
	<div class="wrap-header-cart js-panel-cart">
		...
		<div class="header-cart flex-col-l p-l-65 p-r-25">
			...
			<div id="serviciosCarrito" class="header-cart-content flex-w js-pscroll">
