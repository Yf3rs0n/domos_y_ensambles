<?php
	class Categorias extends Controllers{
		...
		public function Categorias()
		{
			...
			$data['page_title'] = "CATEGORIAS <small> Domos y Ensambles</small>";
			...
			if($_POST){
				if($_SESSION['permisosMod']['d']){
					...
					if($requestDelete == 'ok')
					{
						...
						$arrResponse = array('status' => false, 'msg' => 'No es posible eliminar una categoría con servicios asociados.');
					}else{
