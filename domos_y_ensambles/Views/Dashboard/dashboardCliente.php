<?php headerAdmin($data); ?>
    <main class="app-content">
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-3">
          <a href="<?= base_url() ?>/servicios" class="linkw">
        ...
        <div class="col-md-6">
          <div class="tile">
            <div class="container-title">
              ...
              <tbody>
                <?php 
                    if(count($data['serviciosTen']) > 0 ){
                      foreach ($data['serviciosTen'] as $servicio) {
                 ?>
                <tr>
                  <td><?= $servicio['idservicio'] ?></td>
                  <td><?= $servicio['nombre'] ?></td>
                  <td><?= SMONEY. formatMoney($servicio['precio']) ?></td>
                  <td><a href="<?= base_url() ?>/tienda/servicio/<?= $servicio['idservicio'].'/'.$servicio['ruta'] ?>" target="_blank"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
                </tr>
                <?php } 
                  } ?>
