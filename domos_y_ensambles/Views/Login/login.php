...
<html lang="es">
  ...
  <body>
    ...
    <section class="login-content">
      ...
      <div class="login-box">
        ...
        <form class="login-form" name="formLogin" id="formLogin" action="">
          ...
          <div class="form-group">
            <div class="utility">
              <p class="semibold-text mb-2"><a href="#" data-toggle="flip">¿No sabes tu contraseña?</a></p>
            </div>
          </div>
        ...
        <form id="formRecetPass" name="formRecetPass" class="forget-form" action="">
          <h3 class="login-head"><i class="fa fa-lg fa-fw fa-lock"></i>Recuperacion de contraseña</h3>
          <div class="form-group">
    ...
    <script>
        const base_url = "<?= base_url(); ?>";//NOS DEVUELVE LA URL DEL SITIO (RUTA RAIZ)
    </script>
    ...
    <script type="text/javascript" src="<?= media();?>/js/plugins/sweetalert.min.js"></script><!--LIBRETIA PARA MOSTRAR MENSAJES DE ALERTA-->
